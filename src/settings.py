"""
Django settings for maestri-mvp project.
...
SECRET_KEY = env("SECRET_KEY", default="django-insecure-Z4KhA0bEbrckdF2fe2JfpPhJ0VN2RabqZfhz8AGn")
...
if "DATABASE_URL" in env:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": env("DJANGO_DATABASE_NAME", default="src"),
...
SERVER_EMAIL = env("SERVER_EMAIL", default="noreply@maestri.app.br")
DEFAULT_FROM_EMAIL = env("DEFAULT_FROM_EMAIL", default="contato@maestri.email")
...
EMAIL_SUBJECT_PREFIX = "[maestri-mvp] "
...
SPECTACULAR_SETTINGS = {
    "TITLE": "maestri-mvp",
    "DESCRIPTION": "Juntos dia após dia crescemos dentro de um propósito. Acreditamos que a educação é o maior instrumento que Deus usa para mudar o mundo.",
    "VERSION": "0.1.0",
...
PROJECT_METADATA = {
    "NAME": gettext_lazy("maestri-mvp"),
    "URL": "http://maestri.app.br",
...
LOGGING = {
    ...
    "loggers": {
        ...
        "src": {
            "handlers": ["console"],
            "level": env("SRC_LOG_LEVEL", default="INFO"),
        },
    },
}
